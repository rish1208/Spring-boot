...
public class DemoCtl {
	...
	public DemoResponse display() {
		...
		dto1.setFirstName("rishendra");
		dto1.setLastName("dwivedi");
		dto1.setLoginId("rishendra@gmail.com");
	...
	/*
	 * @GetMapping("testORSResponse") public ORSResponse testORSResponse() {
	 * 
	 * ORSResponse res = new ORSResponse();
	 * 
	 * Map errors = new HashMap(); errors.put("firstName",
	 * "first name is required"); errors.put("lastName", "last name is required");
	 * errors.put("loginId", "login id is required"); errors.put("password",
